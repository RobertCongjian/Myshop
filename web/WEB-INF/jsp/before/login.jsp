...
<center>
    <form action="user/login" method="post" name="loginform">
        <table>
            ...
            <tr>
                <td>E-Mail：</td>
                <td><input type="text" name="uemail" class="textSize" style="width: 300px"/></td>
            </tr>
            <tr>
                <td>密码：</td>
                <td><input type="password" name="upwd" class="textSize" style="width: 300px"/></td>
            </tr>
            <tr>
                <td>验证码：</td>
                <td><input type="text" name="code" class="textSize" style="width: 300px"/></td>
            </tr>
            <tr>
                <td>
